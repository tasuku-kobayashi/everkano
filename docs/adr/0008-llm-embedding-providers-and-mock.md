...
- ステータス: 採用（埋め込みの専用のタイムアウト・リトライを [ADR-0022](0022-embedding-failures-and-audit-additions.md)、用途別のモデル・JSON の出力の検証・モジュールごとのモック応答を [ADR-0035](0035-character-engine-architecture.md)、LLM のストリーミングを [ADR-0037](0037-chat-streaming-sse.md) で追補）
- 日付: 2026-09-25
